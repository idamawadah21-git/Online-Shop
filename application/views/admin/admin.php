    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Admin Pariwisata</div>
            </a>
...
<div class="modal-dialog">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title">Tambah Data Home</h4>
    </div>
    ...
    <div class="modal-footer">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td></td>
                <td>Lorem Ipsum</td>
                <td><a href="">Edit / <a href="">Hapus</td>
            </tr>
    ...
    <!-- Page level plugins -->
    <script src="<?= base_url() ?>assets/bootstrap/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?= base_url() ?>assets/bootstrap/js/demo/chart-area-demo.js"></script>
    <script src="<?= base_url() ?>assets/bootstrap/js/demo/chart-pie-demo.js"></script>
